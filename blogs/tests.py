...
class SeekingAlphaHelper():
    ...
    def getItemDetail(self, url, n):
        ...
        try:
            ...
            print("localStorage before!!!!!!!!!!!!!!!!")
            # print(self.driver.execute_script("return localStorage"))
            # self.driver.execute_script("return document.cookie.split(';').map(function(c){ var d = c.split('='); var k = d[0].toString().trim(); var v = d[1].toString().trim(); document.cookie = k + '=;expires=Thu, 01 Jan 1970 00:00:01 GMT;path=/;'; return 0;});")
            # print(self.driver.execute_script("return document.cookie.split(';').map(function(c){var d = c.split('='); var k = d[0].toString().trim(); var v = d[1].toString().trim(); document.cookie = k + '=;expires=Thu, 01 Jan 1970 00:00:01 GMT;'; return {'key': k, 'value': v};});"))
            
            # self.driver.execute_script("document.cookie.split(';').map(function(c){var d = c.split('=');var k = d[0].toString().trim();var v = d[1].toString().trim();document.cookie=k+'=;expires=Thu, 01 Jan 1970 00:00:01 GMT;path=/;';});")
            # print(self.driver.execute_script("return document.cookie;"))
