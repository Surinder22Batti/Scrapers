...
class LinkedInHelper():
    ...
    def authenticate(self):
        ...
        self.driver.find_element_by_id("username").send_keys("j_ralph1@hotmail.com") # set username here
        self.driver.find_element_by_id("password").send_keys("Surinder#") # set password here
